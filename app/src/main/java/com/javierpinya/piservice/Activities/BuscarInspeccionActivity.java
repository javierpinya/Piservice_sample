...
public class BuscarInspeccionActivity extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case R.id.menu_dashboard:
                        i.setClass(BuscarInspeccionActivity.this, DashboardActivity.class);
                    ...
                    case R.id.menu_buscarc:
                        i.setClass(BuscarInspeccionActivity.this, BuscarCisternaActivity.class);
                        drawerLayout.closeDrawers();
                        startActivity(i);
                        break;
                    case R.id.menu_buscart:
                        ...
                        //fragmentTransaction = true;
                        i.setClass(BuscarInspeccionActivity.this, BuscarTractoraActivity.class);
                        drawerLayout.closeDrawers();
                        startActivity(i);
                        break;
                    case R.id.menu_nuevai:
                        i.setClass(BuscarInspeccionActivity.this, NuevaInspeccionActivity.class);
                        drawerLayout.closeDrawers();
                        startActivity(i);
                        break;
    ...
    private void setFragmentByDefault(){
        changeFragment( new BuscarInspeccionFragment(), navigationView.getMenu().getItem(3));
    }
